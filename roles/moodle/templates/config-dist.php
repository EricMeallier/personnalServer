...
$CFG->dbname    = '{{ dbschema.moodle.database }}';     // database name, eg moodle
$CFG->dbuser    = '{{ dbschema.moodle.username }}';   // your database username
$CFG->dbpass    = '{{ dbschema.moodle.password }}';   // your database password
