...
$CFG->dbname    = '{{ postgresql.moodle.database }}';     // database name, eg moodle
$CFG->dbuser    = '{{ postgresql.moodle.username }}';   // your database username
$CFG->dbpass    = '{{ postgresql.moodle.password }}';   // your database password
...
$CFG->wwwroot   = 'https://moodle.meallier.fr';
